...
export const CREATABLE_PROFILE_KINDS = ['auto-switch', 'auto-detect', 'pac', 'virtual'] as const;
...
export function replaceAndDeleteProfile(
  ...
  const next: ProfileDocumentV2 = {
    ...
    profiles: document.profiles
      ...
      .map((profile) => replaceProfileReference(profile, profileId, replacementProfileId)),
    settings: {
      ...document.settings,
      startupProfileId:
